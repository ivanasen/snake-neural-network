...
if (typeof process !== 'undefined' && process.arch !== 'browser' && 'pid' in process) {
  module.exports = __webpack_require__("./node_modules/threads/lib/defaults.node.js");
} else {
  module.exports = __webpack_require__("./node_modules/threads/lib/defaults.browser.js");
}
...
__webpack_require__("./node_modules/native-promise-only/lib/npo.src.js");

var _config = __webpack_require__("./node_modules/threads/lib/config.js");

var _config2 = _interopRequireDefault(_config);

var _defaults = __webpack_require__("./node_modules/threads/lib/defaults.js");

var _defaults2 = _interopRequireDefault(_defaults);

var _pool = __webpack_require__("./node_modules/threads/lib/pool.js");

var _pool2 = _interopRequireDefault(_pool);

var _worker = __webpack_require__("./node_modules/threads/lib/worker.js");
...
var _job = __webpack_require__("./node_modules/threads/lib/job.js");
...
var _slaveCode = __webpack_require__("./node_modules/threads/lib/worker.browser/slave-code.js");
...
var _slaveCodeUri = __webpack_require__("./node_modules/threads/lib/worker.browser/slave-code-uri.js");
...
if (typeof process !== 'undefined' && process.arch !== 'browser' && 'pid' in process) {
  module.exports = __webpack_require__("./node_modules/threads/lib/worker.node/worker.js");
} else {
  module.exports = __webpack_require__("./node_modules/threads/lib/worker.browser/worker.js");
}
//# sourceMappingURL=worker.js.map
...
/***/ "./node_modules/worker-loader/dist/cjs.js!./src/genetics/Pool.worker.js":
/***/ (function(module, exports, __webpack_require__) {
...
var WorkerClient = function () {
  function WorkerClient(WorkerClass) {
  ...
  _createClass(WorkerClient, [{
    key: "initWorker",
    value: function initWorker(WorkerClass) {
      var _this = this;
      ...
      this.worker.onmessage = function (output) {
        _this.rejects.shift();
        var resolve = _this.resolves.shift();
        resolve(output.data);

        _this.onMessage(output);
      };

      this.worker.onerror = function (error) {
        _this.resolves.shift();
        var reject = _this.rejects.shift();
        reject(error);
    ...
    key: "callWorkerMethod",
    value: function callWorkerMethod(method, methodArgs) {
      var _this2 = this;

      return new Promise(function (resolve, reject) {
        _this2.worker.postMessage({ method: method, methodArgs: methodArgs });
        _this2.resolves.push(resolve);
        _this2.rejects.push(reject);
      });
    }
  }]);
...
var hideInfoBtn = document.getElementById('hide-info-btn');
var infoHolder = document.getElementById('info-holder');
...
var _config = __webpack_require__("./src/config.json");
...
var FoodPool = function () {
  function FoodPool(amount, canvasWidth, canvasHeight) {
    _classCallCheck(this, FoodPool);

    this.amount = amount;
    this.canvasWidth = canvasWidth;
    this.canvasHeight = canvasHeight;
    this.foodSize = _config2.default.FoodSize;
    this.pulseInterval = _config2.default.FoodPulseInterval;
    this.pulseTicks = this.pulseInterval;
    this.color = _config2.default.Food.Color;
    this.food = this.generateFood();
  }

  _createClass(FoodPool, [{
    key: 'generateFood',
    value: function generateFood() {
      var _this = this;

      return _lodash2.default.fill(new Array(this.amount), 0).map(function () {
        return _this.generateFoodPiece();
      });
    }
  }, {
    key: 'generateFoodPiece',
    value: function generateFoodPiece() {
      return (0, _util.getRandomPosition)(this.canvasWidth, this.canvasHeight);
    }
  }, {
    key: 'eat',
    value: function eat(foodIndex) {
      var _this2 = this;

      if (this.food[foodIndex]) {
        var eatenFood = this.food[foodIndex];
        setTimeout(function () {
          fill(_config2.default.Game.ClearBackground.h, _config2.default.Game.ClearBackground.s, _config2.default.Game.ClearBackground.b);
          ellipse(eatenFood.x, eatenFood.y, _this2.foodSize / 1.7, _this2.foodSize / 1.7);
        }, 700);
    ...
    value: function draw() {
      ...
      this.food.forEach(function (piece) {
        _this3.drawFoodPiece(piece.x, piece.y, _this3.foodSize);
      });
    }
  }, {
    key: 'drawFoodPiece',
    value: function drawFoodPiece(x, y, size) {
...
var _charts = __webpack_require__("./src/game/charts.js");

var _charts2 = _interopRequireDefault(_charts);

var _PoolClient = __webpack_require__("./src/genetics/PoolClient.js");

var _FoodPool = __webpack_require__("./src/game/FoodPool.js");

var _FoodPool2 = _interopRequireDefault(_FoodPool);

var _Snake = __webpack_require__("./src/game/Snake.js");
...
var Game = function () {
  function Game(width, height) {
    ...
    this.simulationSpeed = _config2.default.SimulationSpeed;
    this.snakesCount = _config2.default.Population;
    this.snakesList = [];
    ...
    this.width = width;
    this.height = height;
    this.initialBackground = _config2.default.Game.InitialBackground;
    this.clearBackground = _config2.default.Game.ClearBackground;
    this.debugBackground = _config2.default.Game.DebugBackground;
    this.shouldEvolve = _config2.default.ShouldEvolve;
    this.setupCharts();
  }
  ...
  _createClass(Game, [{
    ...
    value: function setupCharts() {
      window.chart = _charts2.default.perfChart();
    }
  }, {
    key: 'setup',
    value: function setup() {
      ...
      this.foodPool = new _FoodPool2.default(_config2.default.FoodAmount, this.width, this.height);
    ...
    value: function reset() {
      ...
      background(this.initialBackground.h, this.initialBackground.s, this.initialBackground.b);

      this.snakesList = [];

      _lodash2.default.range(0, this.snakesCount).forEach(function (id) {
        var snake = new _Snake2.default(_this.snakesList, id, _this.width, _this.height, _this.foodPool, _this.debug);
        _this.snakesList.push(snake);
      });

      setTimeout(function () {
        return $('#snakes-animation-holder').addClass('ready');
      }, 3000);
    }
  }, {
    key: 'draw',
    ...
    value: function clear() {
      this.debug ? background(this.debugBackground.h, this.debugBackground.s, this.debugBackground.b) : background(this.clearBackground.h, this.clearBackground.s, this.clearBackground.b, this.clearBackground.a);
    }
  }, {
    key: 'handleNextTick',
    value: function handleNextTick() {
      if (this.shouldEvolve) {
        if (++_PoolClient.pool.ticksElapsed >= _PoolClient.pool.maxTicks) {
          this.snakesList.forEach(function (snake) {
            return snake.matchResult();
          });
          _PoolClient.pool.newGeneration();
        }
      }
...
var _workerPool = __webpack_require__("./src/workerPool.js");
...
var Snake = function () {
  function Snake(snakesList, id, canvasWidth, canvasHeight, foodPool) {
    var _this = this;
    ...
    this.getInputsAndAssignDir = function () {
      if (++_this.currentDirectionUpdateTicks >= _this.directionUpdatePeriod) {
        _this.currentDirectionUpdateTicks = 0;
        _this.getInputLayerAsync().then(function (inputs) {
          _this.lastInputLayer = inputs;

          _PoolClient.pool.evaluateGenome(_this.lastInputLayer, _this.id).then(function (outputs) {
            if (outputs.length) {
              _this.setPressedKey(outputs[0]);
            }
          });
        });
      }
    ...
    this.setPressedKey = function (value) {
      var newDirection = 2;
      if (value > 0.55) newDirection = 1;
      if (value < 0.45) newDirection = 0;

      if (newDirection === _this.direction) {
        _this.resultToMatch += _config2.default.SameDirectionReward;
      }
    ...
    this.move = function () {
      if (_this.direction !== 2) {
        _this.angle += (_this.direction === 1 ? 1 : -1) * _this.stepAngle;
      }
      _this.pos.x += _this.speed * Math.cos(_this.angle);
      _this.pos.y += _this.speed * Math.sin(_this.angle);
    };
    ...
    this.canvasWidth = canvasWidth;
    this.canvasHeight = canvasHeight;
    this.color = _config2.default.Snake.Color;
    this.history = [];
    this.speed = _config2.default.SnakeSpeed; //maxspeed
    this.size = _config2.default.SnakeSize;
    this.angle = TWO_PI * Math.random(); //
    this.maxAngle = TWO_PI / 9;
    this.stepAngle = this.maxAngle / 20;
    this.direction = 2; // LEFT RIGHT STILL
    this.whiskersize = _config2.default.WhiskerSize;
    this.pos = (0, _util.getRandomPosition)(this.canvasWidth, this.canvasHeight);
    this.lastInputLayer = _lodash2.default.fill(new Array(_config2.default.InputSize), 0); // Keeping it for debugging
    this.lastEvaluation = null; // Same
    this.diedOn = 0;
    this.debug = debug;
    this.foodPool = foodPool;
    this.currentDirectionUpdateTicks = 0;
    this.directionUpdatePeriod = _config2.default.SnakeDirectionUpdatePeriod;
    this.resultToMatch = 0;
  }

  _createClass(Snake, [{
    key: 'getInputLayerAsync',
    value: function getInputLayerAsync() {
      var _this2 = this;

      return new Promise(function (resolve, reject) {
        var whiskerSize = _this2.whiskersize;

        var snakesList = _this2.snakesList.map(function (snake) {
          return {
            history: snake.history.map(function (item) {
        ...
        var food = _this2.foodPool.food.map(function (food) {
          return { x: food.x, y: food.y };
        });
        var foodSize = _this2.foodPool.foodSize;

        var displayedWhiskers = _config2.default.NbWhiskers;

        var inputLayerArgs = {
          displayedWhiskers: displayedWhiskers,
          x: _this2.pos.x,
          y: _this2.pos.y,
          whiskerSize: whiskerSize,
          snakesList: snakesList,
          id: id,
          size: size,
          food: food,
          foodSize: foodSize,
          borders: _util.HIT_BORDERS,
          baseAngle: _this2.angle
        };
        _workerPool2.default.send(inputLayerArgs).on('done', function (response) {
          resolve(response);
    ...
    key: 'drawWhisker',
    value: function drawWhisker(x, y, x1, y1, isFood, hit) {
      fill(360, 100, 100);
      noStroke();
      ellipse(x1, y1, 4);
    ...
    value: function matchResult() {
      _PoolClient.pool.matchResult(this.id, this.resultToMatch);
      this.resultToMatch = 0;
    }
    ...
    value: function store() {
      ...
      if (!!lastHistory) {
        farEnough = (0, _util.distNotSquared)(lastHistory.x, lastHistory.y, this.pos.x, this.pos.y) > this.size * this.size + 1;
      } else {
        farEnough = true;
      }
      ...
      if (farEnough) {
        ...
        if (this.history.length >= _config2.default.SnakeMaxLength) {
          this.history.shift();
        }
      }
    }
    ...
    value: function checkCollisions() {
      ...
      var snakesList = this.snakesList;
      ...
      var others = snakesList.filter(function (c) {
        return c.id != _this3.id;
      });
      ...
      var isColliding = potentialColliders.some(function (pos, i) {
        var d = (0, _util.distNotSquared)(pos.x, pos.y, target.x, target.y);
        var colliding = d < _this3.size * _this3.size;
        if (colliding) {
          if (i > ownHistoryIndex) {
            _this3.diedOn = 1; // He died on enemy
          }
          _this3.stop();
        }
        return colliding;
    ...
    value: function stop() {
      ...
      setTimeout(function () {
        history.forEach(function (pos) {
          fill(_config2.default.Game.ClearBackground.h, _config2.default.Game.ClearBackground.s, _config2.default.Game.ClearBackground.b);
          ellipse(pos.x, pos.y, _this4.size * 1.5, _this4.size * 1.5);
        });
      }, 700);

      this.resetPosition();
      this.resultToMatch += _config2.default.DieReward;
    }
  }, {
    key: 'resetPosition',
    ...
    value: function showHistory() {
      ...
      this.history.forEach(function (pos) {
        return ellipse(pos.x, pos.y, _this5.size, _this5.size);
      });
    ...
    value: function showTrail() {
      ...
      if (this.history.length) {
        var lastHistoryPos = this.history[0];
        fill(_config2.default.Game.ClearBackground.h, _config2.default.Game.ClearBackground.s, _config2.default.Game.ClearBackground.b);
        ellipse(lastHistoryPos.x, lastHistoryPos.y, this.size * 1.5, this.size * 1.5);
      }
    }
  }, {
    key: 'eat',
    value: function eat() {
      ...
      this.foodPool.food.forEach(function (piece, index) {
        var eatsFood = (0, _util.collidePointCircle)(_this6.pos.x, _this6.pos.y, piece.x, piece.y, _this6.foodPool.foodSize);
        if (eatsFood) {
          _this6.foodPool.eat(index);
          _this6.resultToMatch += _config2.default.EatFoodReward;
        }
      });
    }
  }]);
...
var perfChart = function perfChart() {
  return new Chart(document.getElementById('perfChart'), {
    type: 'line',
    data: {
      datasets: [{
        borderColor: _config2.default.ChartMainColor,
        borderWidth: 1.5,
        pointRadius: 0,
        backgroundColor: _config2.default.ChartFillColor,
        label: 'Best Fitness per Generation',
        data: []
      }]
    },
    options: {
      backgroundColor: _config2.default.ChartSecondaryColor,
      scales: {
        xAxes: [{
          type: 'linear',
          position: 'bottom'
...
var _WorkerClient2 = __webpack_require__("./src/WorkerClient.js");

var _WorkerClient3 = _interopRequireDefault(_WorkerClient2);

var _PoolWorker = __webpack_require__("./node_modules/worker-loader/dist/cjs.js!./src/genetics/Pool.worker.js");

var _PoolWorker2 = _interopRequireDefault(_PoolWorker);
...
var PoolClient = function (_WorkerClient) {
  _inherits(PoolClient, _WorkerClient);

  function PoolClient(chart) {
    _classCallCheck(this, PoolClient);

    var _this = _possibleConstructorReturn(this, (PoolClient.__proto__ || Object.getPrototypeOf(PoolClient)).call(this, _PoolWorker2.default));

    _this.ticksElapsed = 0;
    _this.maxTicks = _config2.default.GenerationLength;
    _this.chart = chart;
    return _this;
  }

  _createClass(PoolClient, [{
    key: 'newGeneration',
    ...
    key: 'hydrateChart',
    value: function hydrateChart() {
      var _this2 = this;

      this.getChampionsPerfs().then(function (championsPerfs) {
        _this2.chart.data.datasets[0].data = championsPerfs;
        _this2.chart.update();
      });
    }
  }, {
    key: 'evaluateGenome',
    value: function evaluateGenome(networkInputs, genomeIndex) {
      return this.callWorkerMethod('evaluateGenome', [networkInputs, genomeIndex]);
    }
  }, {
    key: 'matchResult',
    value: function matchResult(genomeIndex, score) {
    ...
    key: 'getChampionsPerfs',
    value: function getChampionsPerfs() {
  ...
  return PoolClient;
}(_WorkerClient3.default);

var pool = exports.pool = new PoolClient();
...
__webpack_require__("./src/global.scss");

var _PoolClient = __webpack_require__("./src/genetics/PoolClient.js");

var _Game = __webpack_require__("./src/game/Game.js");

var _Game2 = _interopRequireDefault(_Game);

__webpack_require__("./src/animationInnerContent.js");

__webpack_require__("./src/chartButtons.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var width = $('#snakes-animation-holder').width(); //import 'game/utils';

var height = $('#snakes-animation-holder').height();
var game = new _Game2.default(width, height);

_PoolClient.pool.init();
_PoolClient.pool.getLoadState();

setTimeout(function () {
  _PoolClient.pool.getChampionsPerfs().then(function (championsPerfs) {
...
exports.HIT_BORDERS = exports.collidePointRect = exports.getRandomPosition = exports.collidePointEllipse = exports.collideLineEllipse = exports.collidePointLine = exports.collidePointCircle = exports.collideLineCircle = exports.collideLineLine = exports.distNotSquared = undefined;
...
var _collideDebug = false;

var distNotSquared = exports.distNotSquared = function distNotSquared(x1, y1, x2, y2) {
  return (x2 - x1) * (x2 - x1) + (y2 - y1) * (y2 - y1);
};

var collideLineLine = exports.collideLineLine = function collideLineLine(x1, y1, x2, y2, x3, y3, x4, y4, calcIntersection) {
...
var collideLineCircle = exports.collideLineCircle = function collideLineCircle(x1, y1, x2, y2, cx, cy, diameter) {
...
var collidePointCircle = exports.collidePointCircle = function collidePointCircle(x, y, cx, cy, d) {
  return distNotSquared(x, y, cx, cy) <= d / 2 * (d / 2);
};

var collidePointLine = exports.collidePointLine = function collidePointLine(px, py, x1, y1, x2, y2, buffer) {
...
var collideLineEllipse = exports.collideLineEllipse = function collideLineEllipse(x1, y1, x2, y2, cx, cy, rx, ry) {
  // is either end INSIDE the ellipse?
  // if so, return true immediately
  var inside1 = collidePointEllipse(x1, y1, cx, cy, rx, ry);
  var inside2 = collidePointEllipse(x2, y2, cx, cy, rx, ry);
...
var collidePointEllipse = exports.collidePointEllipse = function collidePointEllipse(x, y, cx, cy, rx, ry) {
  return (x - cx) * (x - cx) / (rx * rx) + (y - cy) * (y - cy) / (ry * ry) <= 1;
};

var getRandomPosition = exports.getRandomPosition = function getRandomPosition(width, height) {
  var x = Math.random() * width;
  var y = Math.random() * height;
  return createVector(x, y);
};

var collidePointRect = exports.collidePointRect = function collidePointRect(pointX, pointY, x, y, xW, yW) {
...
var centerTopLeft = {
  x: (window.innerWidth - _config2.default.CenterEllipseWidth) / 2,
  y: (window.innerHeight - _config2.default.CenterEllipseHeight) / 2
};
...
var centerBottomRight = {
  x: (window.innerWidth + _config2.default.CenterEllipseWidth) / 2,
  y: (window.innerHeight + _config2.default.CenterEllipseHeight) / 2
};

var HIT_BORDERS = exports.HIT_BORDERS = [[topLeft, topRight], [topLeft, bottomLeft], [topRight, bottomRight], [bottomLeft, bottomRight], [centerTopLeft, centerTopRight], [centerTopLeft, centerBottomLeft], [centerTopRight, centerBottomRight], [centerBottomLeft, centerBottomRight]];
...
var _threads = __webpack_require__("./node_modules/threads/lib/index.js");
